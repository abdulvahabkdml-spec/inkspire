    ...
    <main className="min-h-screen pb-24">
      ...
      <section className="relative overflow-hidden bg-black text-white">
        <div
          ...
          style={{
            backgroundImage:
              'radial-gradient(circle at 80% 30%, #2E5BFF 0%, transparent 55%), radial-gradient(circle at 10% 80%, #4a1a6b 0%, transparent 50%)',
          }}
        />
        {/* Subtle grid overlay */}
        <div
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-20 py-28 md:py-36">
          <p className="text-[10px] font-bold text-[#2E5BFF] mb-4">The Narrative Wing</p>
