    ...
    <div className="min-h-screen bg-[#0F0F0F] text-white p-5 md:p-10 w-full max-w-[100vw] overflow-hidden">
      ...
      <div className="max-w-2xl">
        <div className="flex items-center gap-3 mb-2">
          <Hash size={22} className="text-[#ec5b13]" />
        ...
        <div className="flex gap-3 mb-8">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg py-3 pl-8 pr-4 text-white placeholder-slate-600 focus:outline-none focus:border-[#ec5b13] focus:ring-1 focus:ring-[#ec5b13] transition-all text-sm"
            />
          </div>
          <button
            onClick={addTag}
            className="flex items-center gap-2 px-5 bg-[#ec5b13] hover:bg-[#ec5b13]/80 text-white text-sm font-bold rounded-lg transition-colors"
          >
            <Plus size={16} /> Add
          </button>
        </div>
